...
describe.skipIf(!SHOULD_RUN_INTEGRATION_TESTS)('CLI Download Integration Tests', () => {
  ...
  test('download command shows help with --help flag', async () => {
  ...
  test('download command validates date format', async () => {
    try {
  ...
  test('download command accepts valid date format', async () => {
  ...
  test('download command dry-run shows what would be downloaded', async () => {
    const result = await $`${binaryPath} download --dry-run 2025-08-07`.quiet()
    const output = result.stdout.toString()
  ...
  test('download command handles ThetaData Terminal not running gracefully', async () => {
    ...
    try {
      ...
      const result = await $`THETA_DATA_TERMINAL_URL=http://127.0.0.1:99999 ${binaryPath} download --interval 3600000 2025-08-07`.quiet()
  ...
  test('download command creates correct directory structure', async () => {
    ...
    const result = await $`DATA_OUTPUT_DIR=${customDataDir} ${binaryPath} download --dry-run ${tradeDate}`.quiet()
    const output = result.stdout.toString()
  ...
  test('download command handles multiple date formats correctly', async () => {
  ...
  test('download command handles future dates appropriately', async () => {
  ...
  test('download command handles past dates appropriately', async () => {
  ...
  test('download command respects --dte option with default value', async () => {
  ...
  test('download command respects --dte option with custom value', async () => {
  ...
  test('download command handles various dte values', async () => {
  ...
  test('download command respects --interval option', async () => {
...
describe.skipIf(!SHOULD_RUN_INTEGRATION_TESTS)('CLI Download Environment Variables', () => {
  ...
  test('respects THETA_DATA_TERMINAL_URL environment variable', async () => {
  ...
  test('respects LOG_LEVEL environment variable', async () => {
    ...
    const quietResult = await $`LOG_LEVEL=error ${binaryPath} download --dry-run 2025-08-07`.quiet()
